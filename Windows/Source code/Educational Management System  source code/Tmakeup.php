...
<div class="bodywrapper">
    ...
    <div class="vernav">
        <ul>
            <li><a href="Tgrades.php">录入成绩</a></li>
            <li><a href="Tstatistics.php">成绩统计</a></li>
            <li class="current"><a href="Tmakeup.php">补考安排</a></li>
        </ul>
    ...
    <div class="centercontent">
        ...
        <div class="pageheader">
            <h1 class="pagetitle">补考安排</h1>
        </div><!--pageheader-->
        
            <!--ul class="hornav">
                <li class="current"><a href="Tmakeup.html">补考科目</a></li>
                <li><a href="makeupstu.html">补考学生</a></li>
            </ul-->
        ...
        <div id="contentwrapper" class="contentwrapper">
            ...
            <thead>
                <tr>
                    ...
                    <th class="head1">补考地点</th>
                    <th class="head0">补考时间</th>
                </tr>
            </thead>
            <tbody>
              <tr>
                    <th class="head0">高等数学1</th>
                    <th class="head1">B-528</th>
                    <th class="head0">2017/6/19/9:00</th>
                </tr>
            </tbody>
            <tfoot>
                <tr>
