...
<div class="bodywrapper">
    ...
    <div class="vernav">
    	<ul>
            <li class="current"><a href="Agrades.php">查看各院成绩</a></li>
            <li><a href="school.php">全校成绩分析</a></li>
        </ul>
    ...
    <div class="centercontent">
        ...
        <div id="contentwrapper" class="contentwrapper">
            ...
            <thead>
             ...
             <tbody>
                <tr>
                    <td class="head0" >MA1001</td>
                    <td class="head1">高等数学1</td>
                    <td class="head0">软件学院</td>
                    <td class="head1">13</td>
                    <td class="head0">78.94</td>
                    <td class="head0">100</td>
