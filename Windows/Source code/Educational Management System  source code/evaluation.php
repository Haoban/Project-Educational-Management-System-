...
<div class="bodywrapper">
    ...
    <div class="vernav iconmenu">
    	<ul>
        	<li class="current"><a href="evaluation.php" class="inbox">评估公告</a></li>
    ...
    <div class="centercontent">
        ...
        <div class="pageheader">
            <h1 class="pagetitle">评估公告</h1>
            
            <ul class="hornav">
                <li class="current"><a href="#inbox">公告</a></li>
            </ul>
        </div><!--pageheader-->
