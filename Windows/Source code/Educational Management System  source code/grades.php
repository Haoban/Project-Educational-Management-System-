...
<div class="bodywrapper">
    ...
    <div class="vernav">
        <ul>
            <li class="current"><a href="grades.php">及格成绩查询</a></li>
            <li><a href="bad.php">不及格成绩查询</a></li>
    ...
    <div class="centercontent">
        ...
        <div id="contentwrapper" class="contentwrapper">
            ...
            <thead>
                ...
                $newresult = mysql_query( "SELECT * FROM stu_score WHERE stu_number = '$usernewid'");
