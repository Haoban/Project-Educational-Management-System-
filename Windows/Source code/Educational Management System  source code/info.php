...
<div class="bodywrapper">
    ...
    <div class="header">
    	<ul class="headermenu">
        	<li class="current"><a href="person.php"><span class="icon icon-flatscreen"></span>个人信息</a></li>
    ...
    <div class="vernav2 iconmenu">
    	<ul>
            <li><a href="info.php" class="elements">学籍信息</a></li>
        </ul>
    ...
    <div class="centercontent">
        ...
        <div class="pageheader">
            <h1 class="pagetitle">学籍信息</h1>
            <span class="pagedesc">个人信息</span>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                    ...
                    <thead>
                        <tr>
                            ...
                            <td class="head0"><?php echo mysql_result($result,0,1); ?></td>
                        </tr>
                            <th class="head1">学号:</th>
                            <td class="head1"><?php echo mysql_result($result,0,0); ?></td>
                        </tr>
                            ...
                            <td class="head0"><?php echo mysql_result($result,0,5); ?></td>
                        </tr>
                            <th class="head1">通讯地址:</th>
                            <td class="head1"><?php echo mysql_result($result,0,6); ?></td>
                        </tr>
                            <th class="head0">身份证号:</th>
                            <td class="head0"><?php echo mysql_result($result,0,7); ?></td>
                        </tr>
                            <th class="head1">籍贯:</th>
                            <td class="head1"><?php echo mysql_result($result,0,8); ?></td>
                        </tr>
                            <th class="head0">政治面貌:</th>
                            <td class="head0"><?php echo mysql_result($result,0,9); ?></td>
                        </tr>
                            <th class="head1">学生类别:</th>
                            <td class="head1"><?php echo mysql_result($result,0,10); ?></td>
                        </tr>
                            <th class="head0">毕业中学:</th>
                            <td class="head0"><?php echo mysql_result($result,0,11); ?></td>
                        </tr>
                            <th class="head1">班级:</th>
                            <td class="head1"><?php echo mysql_result($result,0,4); ?></td>
                        </tr>
                    </thead>
        </table>
        </div><!--contentwrapper-->
