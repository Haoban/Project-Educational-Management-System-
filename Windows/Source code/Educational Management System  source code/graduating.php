...
<div class="bodywrapper">
    ...
    <div class="header">
        <ul class="headermenu">
            ...
            <li><a href="selectcourse.html"><span class="icon icon-pencil"></span>选课管理</a></li>
    ...
    <div class="vernav iconmenu">
    	<ul>
            ...
            <li><a href="teaching.php" class="drafts">教学评估</a></li>
            <li class="current"><a href="graduating.php" class="sent">毕业生评估</a></li>
        </ul>
