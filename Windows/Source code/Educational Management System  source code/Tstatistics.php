...
<div class="bodywrapper">
    ...
    <div class="vernav">
        <ul>
            <li><a href="Tgrades.php" class="editor">录入成绩</a></li>
            <li class="current"><a href="Tstatistics.php">成绩统计</a></li>
        ...
        <div id="contentwrapper" class="contentwrapper">
            ...
            <thead>
                <tr>
                    ...
                    <th class="head1">平均分</th>
                    <th class="head0">最高分</th>
                    <th class="head1">及格率</th>
                </tr>
            </thead>
            <tbody>
               <tr>
