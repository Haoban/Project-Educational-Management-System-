...
<div class="bodywrapper">
    ...
    <div class="header">
    	<ul class="headermenu">
            ...
            <li><a href="selectcourse.html"><span class="icon icon-pencil"></span>Manage Blog</a></li>
            <li><a href="evaluation.html"><span class="icon icon-message"></span>Messages</a></li>
            <li><a href="grades.html"><span class="icon icon-chart"></span>Reports</a></li>
        </ul>
